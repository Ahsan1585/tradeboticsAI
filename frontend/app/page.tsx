...
export default function Home() {
  ...
  // 2. Lifecycle Trigger: Fetch data automatically on Auth + T&C
  useEffect(() => {
      ...
      <div className="grid grid-cols-12 gap-8 flex-1">
        ...
        <div className="col-span-12 lg:col-span-6 flex flex-col gap-8">
          {!data ? (
            ...
            <>
              ...
              <button onClick={() => runDeepDive('strike_zone')} className="w-full bg-blue-600 hover:bg-blue-500 py-5 rounded-[32px] font-black text-xs uppercase tracking-[0.3em] shadow-xl shadow-blue-600/20">🎯 Calculate AI-Powered Entry Zone</button>
            </>
          )}
        </div>
        ...
        <div className="col-span-12 lg:col-span-3 space-y-8">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-[40px] p-8 flex flex-col h-[600px] overflow-hidden shrink-0">
             ...
             <button onClick={() => runDeepDive('sentiment')} className="w-full mb-6 bg-blue-600/10 border border-blue-500/20 py-4 rounded-2xl text-blue-500 font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all">🌐 Global AI Sentiment Check</button>
